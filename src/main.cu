...
// das Fraktal hochparallel mit dem neuen mandelbrotHybrid; anschließend wird kompaktes
// Complexity-Feedback gesammelt und auf den nächsten Zoom-Schritt angewendet.
...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // 3) Fraktal-Hybrid-Kernel: ein Block pro Tile
