...
// Zeilen: 109
// 🐭 Maus-Kommentar: Kiwi – Kein Shadowing mehr, alle globalen Variablen klar: g_ctx, g_zoomBus. Kompakt & warnungsfrei. Otter und Schneefuchs lächeln.
...
cmd.zoomBefore = (float)(frameCtx.zoom / Settings::AUTOZOOM_SPEED);
