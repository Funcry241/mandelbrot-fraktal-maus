...
// ASCII‑only; no logging side‑effects.
...
// 16‑byte POD compatible with CUDA's double2 (same layout: two doubles).s
...
//  * 'bailoutRadius' is used only for optional host‑side diagnostics; the
//    generated sequence remains complete for perturbation.
