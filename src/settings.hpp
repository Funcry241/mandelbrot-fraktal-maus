...
inline constexpr float VARIANCE_THRESHOLD     = 1e-12f; // Hauptschwelle für interessante Tiles – je kleiner, desto empfindlicher
inline constexpr float MIN_VARIANCE_THRESHOLD = 1e-10f; // Notbremse für zu starkes Auto-Zoom – empfohlen: 1e-10 bis 1e-8
...
// 💚 CUDA Tile-Größe – kleinere Tiles = genauere Entropieauswertung, aber höhere Rechenlast
inline constexpr int BASE_TILE_SIZE = 8; // empfohlen: 8 bis 32 – 8 für beste Genauigkeit
