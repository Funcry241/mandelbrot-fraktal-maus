...
namespace Settings {
    ...
    inline constexpr float OFFSET_STEP_FACTOR = 0.30f;  // Größere Werte = schnelleres Schwenken
    inline constexpr float ZOOM_STEP_FACTOR   = 0.35f;  // Größere Werte = schnellerer Zoom
}
